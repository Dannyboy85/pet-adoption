...
const petBuilder = (animals) => {
   let domString = '';
   animals.forEach((pet) => {
       domString += `<div class = "card">`
       domString += `<h2>${pet.name}</h2>`;
       domString += `<h5>${pet.color}</h5>`;
       domString += `<h5>${pet.specialSkill}</h5>`;
       domString += `<h5>${pet.type}</h5>`;
